  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // save the images generated by user in the firebase realtime database
        const imageRef = ref(
          database,
      ...
      <form onSubmit={handleSubmit} className="space-y-6 pt-10">
        ...
        <div className="flex flex-wrap gap-4 p-4 overflow-hidden">
          <div className="p-4">
            ...
            <div className="flex overflow-x-scroll pb-2 pt-4">
              {[
                "White",
                "Black",
                "Red",
          ...
          <div className="p-4">
            <label className="text-xl font-bold">What is your skintone?</label>
            <div className="flex overflow-x-scroll pb-2 pt-4">
          ...
          <div className="p-4">
            <label className="text-xl font-bold">What is your occasion?</label>
            <div className="flex overflow-x-scroll pb-2 pt-4">
              {[
                "Birthday",
                "Anniversary",
          ...
          <div className="p-4">
            <label className="text-xl font-bold">What is your gender?</label>
            <div className="flex overflow-x-scroll pb-2 pt-4">
          ...
          <div className="p-4">
            <label className="text-xl font-bold">What is your age?</label>
            <div className="flex overflow-x-scroll pb-2 pt-4">
